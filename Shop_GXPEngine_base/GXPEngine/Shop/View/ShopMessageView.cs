...
namespace View
{
    ...
    public class ShopMessageView : Canvas
    {
        ...
        //                                                  ShopMessageDisplay()
        //------------------------------------------------------------------------------------------------------------------------
        public ShopMessageView(ShopModel shop) : base(800, 600)
        {
            this.shop = shop;
        }
        ...
        private void DrawMessages()
        {
            ...
            for (int index = 0; index < messages.Length; index++) {
                ...
                graphics.DrawString(message, SystemFonts.CaptionFont, Brushes.White, 0, FontHeight + index * FontHeight);
            }

            graphics.DrawString("Money: " + shop.GetPlayerMoneyString(), SystemFonts.CaptionFont, Brushes.White, 100, 500);

            graphics.DrawString("Press C to change currency", SystemFonts.CaptionFont, Brushes.White, 100, 520);
